...
export class AccessDbFileReader implements IFileReader<MDBReader> {
  ...
  public async loadPackages(database: MDBReader, registry: DataRegistry): Promise<void> {
  ...
  public async loadElementConnectors(database: MDBReader, registry: DataRegistry): Promise<void> {
  ...
  public async loadAttributes(database: MDBReader, registry: DataRegistry): Promise<void> {
  ...
  public async loadElements(database: MDBReader, registry: DataRegistry): Promise<void> {
    const objects = database.getTable(EaTable.Object).getData();
    const query = `
  ...
  public async loadDiagrams(database: MDBReader, registry: DataRegistry): Promise<void> {
  ...
  private async loadDiagramObjects(mdb: MDBReader, diagrams: EaDiagram[]): Promise<void> {
