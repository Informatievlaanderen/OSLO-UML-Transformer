...
describe('DataRegistry equality', () => {
  it('should produce equal registries for accessdb and sqlite input', async () => {
    ...
    const sqliteRegistry = await new FileReaderService(
      ...
      // eslint-disable-next-line max-len
      'https://github.com/Informatievlaanderen/OSLO-UML-Transformer/raw/refs/heads/integration-test-files/oslo-converter-uml-ea/01-AssociatiesMijnDomein.qea?raw=true',
    );
