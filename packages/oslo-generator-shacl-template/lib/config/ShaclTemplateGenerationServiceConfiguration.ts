...
@injectable()
export class ShaclTemplateGenerationServiceConfiguration
  implements IConfiguration
{
  ...
  /**
   * Whether to add rdfs:member links from a main container to all shapes
   */
  ...
  public get applicationProfileURL(): string {
    ...
    if (this._applicationProfileURL === undefined) {
      throw new Error(
        `Trying to access "applicationProfileURL" before it was set.`,
      );
    }
  ...
  public get addConstraintMessages(): boolean {
    ...
    if (this._addConstraintMessages === undefined) {
      throw new Error(
        `Trying to access "addConstraintMessages" before it was set.`,
      );
    }
  ...
  public get addConstraintRuleNumbers() {
    ...
    if (this._addConstraintRuleNumbers === undefined) {
      throw new Error(
        `Trying to access "addConstraintRuleNumbers" before it was set.`,
      );
    }
