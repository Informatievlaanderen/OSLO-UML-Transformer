...
exports.cleanup = exports.generateEapConfig = exports.getConfigFiles = exports.addRepositoryUrl = exports.getConfigFile = exports.readFiles = exports.readFile = exports.listFiles = exports.createZipFromGithub = exports.downloadFile = exports.extractZip = void 0;
...
const cleanup = async (zipPath, repoPath) => {
    try {
    ...
    try {
        await fs_1.promises.rmdir(repoPath, { recursive: true });
